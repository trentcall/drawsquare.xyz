$(document).ready(function() {
	$.Juitter.start({
		...
		searchObject:"pickle,pickles,pickled", // needed, you can insert a username here or a word to be searched for, if you wish multiple search, separate the words by comma.
	...
	$("#aIphone").click(function(){
		...
		$.Juitter.start({
			...
			searchObject:"pickle,pickles,pickled",
